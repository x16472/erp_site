...
這是一套前後端分離的幼稚園官方網站與內部平台。公開網站呈現企業宗旨、園務規模、營運據點與教職團隊；員工入口整合出勤、園務填報、教育訓練與內部資訊；後台管理中心則提供受控的網站設定、唯讀資料查閱及待審佇列。
...
- 其餘首頁區域已統一強化層次、卡片、營運據點、招生參觀與行動版版面。
...
- 營運資料依營運分類填寫數量、說明與日期，並以待審流程集中管理。
- 新增的營運紀錄會保存建立員工編號，供 MIS 待審佇列依員工分類。
- 教育訓練提供 Word 文件分類、段落查閱及互動題庫。
- 營運資料與教育訓練皆改為分頁介面，將填報、生命週期、文件查閱與知識檢核分開管理。
